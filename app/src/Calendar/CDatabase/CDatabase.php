<?php
/**
 * Database wrapper, provides a database API for the framework 
 * but hides details of implementation.
 *
 */
class CDatabase {
  ...
  public function __construct($options) {
    $default = array(
      ...
      'password' => null,
      'driver_options' => null,
      'fetch_style' => PDO::FETCH_OBJ,//the result of fetch will be an object instead of an array
    );
